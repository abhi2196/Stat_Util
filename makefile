all: obj/stat_util.o obj/common.o obj/hash_util.o obj/mem_cache_util.o bin/statrun
...
bin/statrun: obj/stat_util.o obj/hash_util.o obj/common.o obj/mem_cache_util.o src/stat1.c
	gcc -g -I ./include obj/stat_util.o obj/hash_util.o obj/common.o obj/mem_cache_util.o src/stat1.c -o bin/statrun -l memcached -l pthread `pkg-config --cflags --libs glib-2.0`
clean:
	 $(RM) obj/stat_util.o obj/common.o obj/hash_util.o obj/mem_cache_util.o bin/statrun  
